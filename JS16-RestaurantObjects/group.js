...
var limes = new FoodItem ('Limes', 5, true, true, false)
var rice = new FoodItem ('Rice', 15, true, true, true)
var beans = new FoodItem ('Beans', 10, true, true, true)
var chz = new FoodItem ('Cheese', 10, true, true, true)
var chx = new FoodItem ('Chicken', 120, false, true, true)
var salsa = new FoodItem ('Salsa', 15, true, true, true)
//var tequila = new DrinkItem ('Tequila', 65, true, true, true)
//Drinks
var margarita = new Drink ('Margarita', 'Yum!', 10, ['Tequila', 'Cointreau', 'limes', 'Salt'])
//Plates
var enchillada = new Plate ('Chicken Enchillada', 'Cheesy', 6, [rice, beans, chx, salsa, chx])
var guacamole = new Plate ('Gualcamole', 'Green goodness', 4, [avocado, cilantro, onions, limes])
//Menu
var myMenu = new Menu ([enchillada, guacamole], [margarita])
//Restaurants
